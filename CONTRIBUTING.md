...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/estree-util-unassert
   cd estree-util-unassert
   ```
...
```sh
https://github.com/flex-development/estree-util-unassert/compare/main...$branch
```
...
[discussion-qa]: https://github.com/flex-development/estree-util-unassert/discussions/new?category=q-a
